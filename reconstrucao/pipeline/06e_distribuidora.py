...
from _paths import RAW, INTERIM_ORIG, PROCESSED_ORIG, OUT, ANO_UC
B=str(RAW)+"/aneel"
...
# Inteiro que aceita nulo: com a referencia de marco de 2026 ha um municipio sem
# registro no INDGER (Acegua, RS), e um astype(int) cru quebraria a execucao em vez
# de deixar o campo dizer que nao sabe.
df["rank_tarifa"]=df.tarifa_municipal.rank(ascending=False,method="min").astype("Int64")
